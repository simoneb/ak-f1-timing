...
#pragma warning restore 618
        ...
        [FlagUsage("Show usage.", AlternateName1 = "?", AlternateName2 = "h", AllowOnOff = false, Category = "HELP", Optional = true),]
        public bool help;

        [FlagUsage("Show version.", AlternateName1 = "v", AllowOnOff = false, Category = "HELP", Optional = true)]
        public bool version;
    }
}
